...
const TYPE_ICONS = {
  ...
  application: { icon: FileText, color: 'text-indigo-400', bg: 'bg-indigo-500/10', border: 'border-indigo-500/25' },
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-text-muted mt-1">
            Stay on top of recruiter invitations, drive approvals, and interview round updates.
          </p>
        </div>
        ...
        <div className="bg-bg-surface border border-border rounded-2xl p-12 text-center space-y-4">
          ...
          <div className="max-w-md mx-auto space-y-1">
            ...
            <p className="text-xs text-text-muted">
              You will receive real-time notifications when placement drives are approved, interviews are scheduled, or your application status changes.
            </p>
          </div>
        </div>
      ) : (
